...
/**
 * A distributed collection of data organized into named columns, and can be
 * created using various functions in {@link SQLContext}.
 *
 * Once created, it can be manipulated using the various domain-specific-language (DSL) functions
 * defined in: {@link DataFrame} (this class), {@link Column}, and {@link functions}.
 *
 * @example <caption>To select a column from the data frame, use the `col` method.</caption>
 *   var ageCol = people.col("age")  // in Java
 *
...
class DataFrame {
     ...
     *
     * @example <caption>perform a full outer join between `df1` and `df2`</caption>
     ...
     * @param col {@link Column} or column name to sort by.
     * @param [cols=[]] list of additional {@link Column} or column names to sort by.
     * @since 1.3.0
     */
     ...
     * @param colName column name to select.
     * @since 1.3.0
     */
     ...
     *
     * @param [cols=[]] list of column names (string) or expressions ({@link Column}).
     ...
     * SQL expressions.
     *
     * @param [exprs=[]] list of SQL expressions).
     * @since 1.3.0
     */
     ...
     *
     * @param [cols=[]] list of column names (string) or expressions ({@link Column}) to group by.
     * @since 1.3.0
     */
     ...
     * @param col {@link Column} or column name to drop.
     * @since 1.4.0
     */
     ...
     *
     * If partition expresions are provided, partitioned by the given
    ...
    write() /*: DataFrameWriter*/ {
        throw new Error("DataFrameWriter wrapper not yet implemented");
    }
}
