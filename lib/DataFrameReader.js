...
class DataFrameReader {
    ...
    /**
     * The promisified version of {@link DataFrameReader#json}
     *
     * @param path
     * @since 1.4.0
     */
    jsonPromised(path /*: String */)/*: DataFrame */ {
        return new Promise((resolve, reject) => {
                ...
                this.format("json").load(path, jvm_cb)
            });
    }
    ...
    /**
     * The promisified version of {@link DataFrameReader#text}
     *
     * @param path
     * @since 1.6.0
     */
    textPromised(path /*: String */)/*: DataFrame */ {
        return new Promise((resolve, reject) => {
                let jvm_cb =  (err, res) => {
                    if (err) reject(err);
                    resolve(res);
                ...
                this.format("text").load(path, jvm_cb)
            });
    }
}
