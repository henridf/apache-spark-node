...
class Functions {
    ...
    static approxCountDistinct(col /*: Column*/, rsd=null /*: Double*/) /*: Column*/ {
        if (rsd === null) {
            return F.approxCountDistinct(col, rsd);
        } else {
     ...
     * {@link Column}, the second one can be either a Number of a Column.
     *
     * @param l
     * @param r
     * @since 1.4.0
    ...
    static conv(col /*: Column*/, fromBase /*: Int*/, toBase /*: Int*/) /*: Column*/ {
        return F.conv(col /*: Column*/, fromBase, toBase);
    }
     ...
     * @param col column
     * @param [pos=null] position
     * @since 1.5.0
     */
    static locate(substr /*: String*/, col /*: Column*/, pos=null /*: Int*/) /*: Column*/ {
        if (pos === null) {
            return F.locate(substr /*: String*/, col);
        } else {
            return F.locate(substr /*: String*/, col, pos);
        }
    }
    ...
    static lpad(col /*: Column*/, len /*: Int*/, pad /*: String*/) /*: Column*/ {
        return F.lpad(col /*: Column*/, len, pad);
    }
     ...
     * @since 1.5.0
     */
    static regexp_extract(col /*: Column*/, re /*: String*/, groupIdx /*: Int*/) /*: Column*/ {
        return F.regexp_extract(col, re, groupIdx);
    }
     ...
     * @since 1.5.0
     */
    static regexp_replace(col /*: Column*/, re /*: String*/, replacement /*: String*/) /*: Column*/ {
        return F.regexp_replace(col, re, replacement);
    }
    ...
    static rpad(col /*: Column*/, len /*: Int*/, pad /*: String*/) /*: Column*/ {
        return F.rpad(col /*: Column*/, len, pad);
    }
    ...
    /**
     * Splits str around pattern (pattern is a java regular expression).
     *
     * @param col
     * @param re regex
     * @since 1.5.0
     */
    static split(col /*: Column*/, re /*: String*/) /*: Column*/ {
        return F.split(col, re);
    }
    ...
    static substring(col /*: Column*/, pos /*: Int*/, len /*: Int*/) /*: Column*/ {
        return F.substring(col /*: Column*/, pos, len);
    }
    ...
    static substring_index(col /*: Column*/, delim /*: String*/, count /*: Int*/) /*: Column*/ {
        return F.substring_index(col /*: Column*/, delim, count);
    }
    ...
    static translate(col /*: Column*/, matchingString /*: String*/, replaceString /*: String*/) /*: Column*/ {
        return F.translate(col /*: Column*/, matchingString, replaceString);
    }
    ...
    static add_months(col /*: Column*/, numMonths /*: Int*/) /*: Column*/ {
        return F.add_months(col, numMonths);
    }
    ...
    static date_format(col /*: Column*/, format /*: String*/) /*: Column*/ {
        return F.date_format(col, format);
    }
    ...
    static datediff(endCol /*: Column*/, startCol /*: Column*/) /*: Column*/ {
        return F.datediff(endCol, startCol);
    }
    ...
    static next_day(col /*: Column*/, dayOfWeek /*: String*/) /*: Column*/ {
        return F.next_day(col, dayOfWeek);
    }
     ...
     * @since 1.5.0
     */
    static from_unixtime(col /*: Column*/, f=null /*: String*/) /*: Column*/ {
        if (f === null) {
            return F.from_unixtime(col);
        } else {
            return F.from_unixtime(col, f);
        }
    }
    ...
    static unix_timestamp(col=null /*: Column*/, format=null /*: String*/) /*: Column*/ {
        if (col === null) {
            ...
            return F.unix_timestamp(col);
        } else {
            return F.unix_timestamp(col, format);
        }
    }
    ...
    static from_utc_timestamp(col /*: Column*/, tz /*: String*/) /*: Column*/ {
        return F.from_utc_timestamp(col, tz);
    }
    ...
    static to_utc_timestamp(col /*: Column*/, tz /*: String*/) /*: Column*/ {
        return F.to_utc_timestamp(col, tz);
    }
    ...
    static json_tuple(col /*: Column*/, ...fields /*: String* */) /*: Column*/ {
        return F.json_tuple(col, ...fields);
    }
