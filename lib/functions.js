...
class Functions {
     ...
     * @since 1.6.0
     */
    static stddev_samp(e /*: Column*/) /*: Column*/ {
        return F.stddev(col);
    }
     ...
     * @since 1.6.0
     */
    static stddev_pop(e /*: Column*/) /*: Column*/ {
        return F.stddev(col);
    }
     ...
     * @since 1.6.0
     */
    static variance(e /*: Column*/) /*: Column*/ {
     ...
     * @since 1.6.0
     */
    static var_samp(e /*: Column*/) /*: Column*/ {
        return F.var(col);
    }
     ...
     * @since 1.6.0
     */
    static var_pop(e /*: Column*/) /*: Column*/ {
        return F.var(col);
    }
     ...
     * @since 1.4.0
     */
    static bitwiseNOT(e /*: Column*/) /*: Column*/ {
     ...
     * @since 1.5.0
     */
    static factorial(e /*: Column*/) /*: Column*/ {
     ...
     * @since 1.4.0
     */
    static log(base /*: Double*/, columnName /*: String*/) /*: Column*/ {
     ...
     * @since 1.5.0
     */
    static round(e /*: Column*/, scale=0 /*: Int*/) /*: Column*/ {
     ...
     * @since 1.5.0
     */
    static shiftLeft(e /*: Column*/, numBits /*: Int*/) /*: Column*/ {
     ...
     * @since 1.5.0
     */
    static shiftRight(e /*: Column*/, numBits /*: Int*/) /*: Column*/ {
     ...
     * @since 1.5.0
     */
    static shiftRightUnsigned(e /*: Column*/, numBits /*: Int*/) /*: Column*/ {
     ...
     * @since 1.5.0
     */
    static sha2(e /*: Column*/, numBits /*: Int*/) /*: Column*/ {
     ...
     * @since 1.5.0
     */
    static initcap(e /*: Column*/) /*: Column*/ {
     ...
     * @since 1.5.0
     */
    static locate(substr /*: String*/, str /*: Column*/) /*: Column*/ {
     ...
     * @since 1.5.0
     */
    static locate(substr /*: String*/, str /*: Column*/, pos /*: Int*/) /*: Column*/ {
     ...
     * @since 1.5.0
     */
    static regexp_extract(e /*: Column*/, exp /*: String*/, groupIdx /*: Int*/) /*: Column*/ {
     ...
     * @since 1.5.0
     */
    static regexp_replace(e /*: Column*/, pattern /*: String*/, replacement /*: String*/) /*: Column*/ {
     ...
     * @since 1.5.0
     */
    static unbase64(e /*: Column*/) /*: Column*/ {
     ...
     * @since 1.5.0
     */
    static soundex(e /*: Column*/) /*: Column*/ {
     ...
     * @since 1.5.0
     */
    static quarter(e /*: Column*/) /*: Column*/ {
     ...
     * @since 1.5.0
     */
    static dayofmonth(e /*: Column*/) /*: Column*/ {
     ...
     * @since 1.5.0
     */
    static dayofyear(e /*: Column*/) /*: Column*/ {
     ...
     * @since 1.5.0
     */
    static last_day(e /*: Column*/) /*: Column*/ {
     ...
     * @since 1.5.0
     */
    static weekofyear(e /*: Column*/) /*: Column*/ {
     ...
     * @since 1.5.0
     */
    static to_date(e /*: Column*/) /*: Column*/ {
     ...
     * @since 1.3.0
     */
    static explode(e /*: Column*/) /*: Column*/ {
