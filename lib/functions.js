...
class Functions {
    ...
    static locate(substring /*: String*/, column /*: Column*/, position=null /*: Int*/) /*: Column*/ {
        if (position === null) {
            return F.locate(substring /*: String*/, column);
        } else {
            return F.locate(substring /*: String*/, column, position);
        }
    }
    ...
    static regexp_extract(col /*: Column*/, regex /*: String*/, groupIdx /*: Int*/) /*: Column*/ {
        return F.regexp_extract(col, regex, groupIdx);
    }
    ...
    static regexp_replace(col /*: Column*/, regex /*: String*/, replacement /*: String*/) /*: Column*/ {
        return F.regexp_replace(col, regex, replacement);
    }
